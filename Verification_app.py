...
filtered_df['Time_str']=filtered_df['Time'].dt.strftime('%d-%m-%Y')
st.write(filtered_df.dropna().groupby('Time_str').mean())
avg_df = filtered_df.groupby('Time_str').mean().reset_index()
